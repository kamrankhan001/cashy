...
@section('main')
    ...
    <div class="max-w-screen-lg mx-auto px-4 mb-20">
        <!-- Success Message -->
        @if (session('success'))
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <form action="{{ route('account.update', $user->id) }}" method="POST">
                ...
                <div class="flex justify-end">
                    @if (!$user?->account)
                        <button type="submit"
                            class="w-full sm:w-auto bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-300">
                            Save
                        </button>
                    @endif
                </div>
